...
The comments field is fascinating and ripe for text analysis.   We'll leave it in for now, but it would need to be further prepared for any regression to be done.
...
For the remaining two fields (self_employed and age), since we will only lose 26 observations, let's simply remove those observations.
...
# References
  ...
  * Harvard Health Publishing. What Causes Depression? - Harvard Health.â Harvard Health Blog, 17 Apr. 2017, www.health.harvard.edu/mind-and-mood/what-causes-depression.
